...
public class FVarsTest {
    ...
    public void test_Car_allInstances() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()", new DefaultOclContext());
    ...
    public void test_Car_allInstances_isUnique() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->isUnique()", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
    ...
    public void test_Car_allInstances_size() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->size()", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
    ...
    public void test_Car_allInstances_isEmpty() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->isEmpty()", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
    ...
    public void test_Car_allInstances_notEmpty() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->notEmpty()", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
    ...
    public void test_Car_allInstances_collect() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->collect(c|c.Car:color)", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
    ...
    public void test_Car_allInstances_select() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->select(c|c.Car:color = 'blue')", new DefaultOclContext());
    ...
    public void test_Car_allInstances_forAll() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->forAll(c|c.Car:color = 'blue')", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
    ...
    public void test_Car_allInstances_exists() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->exists(c|c.Car:color = 'blue')", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
    ...
    public void test_Car_allInstances_reject() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->reject(c|c.Car:color = 'blue')", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
    ...
    public void test_Car_allInstances_collect_flatten() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->collect(c|c.Car:owners)->flatten()", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
    ...
    public void test_body_var_assoc() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->collect(c|c.Car:owners)", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_var() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->collect(c|c)", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_Car_allInstances() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->collect(c|Car::allInstances())", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_var_att_binary_comparison() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->collect(c|c.Car:color = 'blue')", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_var_att_unary_comparison() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->collect(c|c.Car:color.oclIsUndefined())", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_var_assoc_isEmpty() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->collect(c|c.Car:owners->isEmpty())", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_var_assoc_notEmpty() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->collect(c|c.Car:owners->notEmpty())", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_var_assoc_isUnique() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->collect(c|c.Car:owners->isUnique())", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_var_assoc_size() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->collect(c|c.Car:owners->size())", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_var_assoc_exists() throws OclParseException {
        OclExpression exp = OclExpression.parse("Car::allInstances()->collect(c|c.Car:owners->exists(p|p = p))", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
