...
public class FVarsTest {
    ...
    public void test_Car_allInstances() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()", new DefaultOclContext());
    ...
    public void test_Car_allInstances_isUnique() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->isUnique()", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
    ...
    public void test_Car_allInstances_size() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->size()", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
    ...
    public void test_Car_allInstances_isEmpty() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->isEmpty()", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
    ...
    public void test_Car_allInstances_notEmpty() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->notEmpty()", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
    ...
    public void test_Car_allInstances_collect() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->collect(c|c.Car:color)", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
    ...
    public void test_Car_allInstances_select() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->select(c|c.Car:color = 'blue')", new DefaultOclContext());
    ...
    public void test_Car_allInstances_forAll() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->forAll(c|c.Car:color = 'blue')", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
    ...
    public void test_Car_allInstances_exists() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->exists(c|c.Car:color = 'blue')", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
    ...
    public void test_Car_allInstances_reject() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->reject(c|c.Car:color = 'blue')", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
    ...
    public void test_Car_allInstances_collect_flatten() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->collect(c|c.Car:owners)->flatten()", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
    ...
    public void test_body_var_assoc() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->collect(c|c.Car:owners)", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_var() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->collect(c|c)", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_Car_allInstances() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->collect(c|Car::allInstances())", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_var_att_binary_comparison() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->collect(c|c.Car:color = 'blue')", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_var_att_unary_comparison() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->collect(c|c.Car:color.oclIsUndefined())", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_var_assoc_isEmpty() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->collect(c|c.Car:owners->isEmpty())", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_var_assoc_notEmpty() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->collect(c|c.Car:owners->notEmpty())", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_var_assoc_isUnique() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->collect(c|c.Car:owners->isUnique())", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_var_assoc_size() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->collect(c|c.Car:owners->size())", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_var_assoc_select() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->collect(c|c.Car:owners->select(p|p=p))->flatten()", new DefaultOclContext());
    ...
    public void test_body_var_assoc_forAll() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->collect(c|c.Car:owners->forAll(p|p = p))", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_var_assoc_reject() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->collect(c|c.Car:owners->reject(p|p = p))->flatten()", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) ((IteratorExp) exp).getSource()).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_var_assoc_exists() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->collect(c|c.Car:owners->exists(p|p = p))", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp) exp).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
        List<String> expectedFVars = Arrays.asList("c");
        boolean isValid = actualFVars.size() == expectedFVars.size();
    ...
    public void test_body_second_level_body_2() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->collect(c|c.Car:owners->forAll(p|p.Person:name=c.Car:color))", new DefaultOclContext());
        OclExpression subExp = ((IteratorExp)((IteratorExp) exp).getBody()).getBody();
        List<String> actualFVars = VariableUtils.FVars(subExp);
    ...
    public void test_body_three_levels() throws OclParseException {
        OclExpression exp = RobertOcl2PojoParser.parse("Car::allInstances()->forAll(c|c.Car:owners->forAll(p|p.Person:ownedCars->forAll(c1|c1=c)))", new DefaultOclContext());
        List<String> actualFVars = VariableUtils.FVars(exp);
        List<String> expectedFVars = new ArrayList<String>();
        boolean isValid = actualFVars.size() == expectedFVars.size();
        for(int i = 0; i < actualFVars.size() && isValid; i++) {
