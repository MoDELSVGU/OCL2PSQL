...
//                "Car::allInstances()->forAll(c| (c.Car:color <> 'blue') or (c.Car:color = 'yellow'))",
...
//                "Car.allInstances()->exists(c| true)",
//                "Car.allInstances()->forAll(c| (c.color <> 'blue') or (c.color = 'yellow'))",
...
//                "Car.allInstances()->select(c| true)",
//                "Car.allInstances()->reject(c| c.color = 'blue')",
//                "Car.allInstances()->reject(c| true)",
//                "Car.allInstances()->forAll(c| c.owners -> reject(p| p.name ='Hoang'))",
//                "Car.allInstances()->isEmpty()",
