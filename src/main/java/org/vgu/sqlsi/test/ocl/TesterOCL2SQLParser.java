...
public class TesterOCL2SQLParser {
    ...
    public static void main(String[] args)
         ...
         */
//        String filePath = "/Users/thian/prjcts/eclipseWork/OCL2PSQL/src/main/resources/CarPerson_context.json";
        String filePath = "C:\\Users\\ngpbh\\eclipse-workspace\\OCL2PSQL\\src\\main\\resources\\CarPerson_context.json";
//        String filePath = "/Users/clavel/VGU/Repositories/SqlSI/Documentation/CarPerson_context.json";
        ...
        test(ocl2psqlParser, "Car::allInstances()->isEmpty()");
        test(ocl2psqlParser, "Car::allInstances()->collect(c|c.Car:color)->isEmpty()");
        test(ocl2psqlParser, "Car::allInstances()->collect(c|c.Car:owners->isEmpty())");
        test(ocl2psqlParser, "Car::allInstances()->forAll(c|c.Car:owners->isEmpty())");
        test(ocl2psqlParser, "Car::allInstances()->exists(c|c.Car:owners->isEmpty())");
        
        test(ocl2psqlParser, "Car::allInstances()->notEmpty()");
        test(ocl2psqlParser, "Car::allInstances()->collect(c|c.Car:color)->notEmpty()");
