...
//	public String mapOCLStringToSQLString(String oclExpression) throws OclParseException, ParseException, IOException {
//		TTCReturnModel returnModel = new TTCReturnModel();
//		final long startNanoTime = System.nanoTime();
//		Statement statement = ocl2PsqlSvc.mapToSQL(oclExpression);
//		final long endNanoTime = System.nanoTime();
...
//	}
	...
	public Statement mapOCLStringToSQLStatement(String oclString)
			throws OclParseException, ParseException, IOException {
		return ocl2PsqlSvc.mapToSQL(oclString);
	}
	
	public String mapOCLExpressionToSQLString(Expression oclExpression)
			throws OclParseException, ParseException, IOException {
		return mapOCLExpressionToSQLStatement(oclExpression).toString();
	}
	
	public String mapOCLStringToSQLString(String oclString)
			throws OclParseException, ParseException, IOException {
		return mapOCLStringToSQLStatement(oclString).toString();
	}
	
	public Statement mapOCLExpressionToSQLStatement(Expression oclExpression)
			throws OclParseException, ParseException, IOException {
		return ocl2PsqlSvc.mapToSQL(oclExpression);
	}

//	public TTCReturnModel mapOCLXMIToSQLString(String dataModelName, String dataModel, String oclXMIExpression)
//			throws IOException {
