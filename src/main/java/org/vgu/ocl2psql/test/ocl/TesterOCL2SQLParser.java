...
//            String test = "Car::allInstances()->collect(c|c.color)";
            ...
            System.out.println( "\n==============~ Result ~==============\n" );
            OclExpression oclExp = OclExpression.parse( test, new DefaultOclContext() );
            OclExpressionDeParser deParser = new OclExpressionDeParser();
            oclExp.accept( deParser );
            System.out.println(deParser.getDeParsedStr());
