...
public class BooleanLiteralExpDeParser extends OclExpressionDeParser {

    private String deParsedStr;
    
    public BooleanLiteralExpDeParser() {
        this("");
    }

    public BooleanLiteralExpDeParser(String deParsedStr) {
    ...
    public void visit( BooleanLiteralExp booleanLiteralExp ) {
        this.deParsedStr = String.valueOf(booleanLiteralExp.isBooleanSymbol());
    }
