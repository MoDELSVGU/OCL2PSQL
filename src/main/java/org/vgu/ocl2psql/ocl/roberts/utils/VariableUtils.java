...
package org.vgu.ocl2psql.ocl.roberts.utils;
...
public class VariableUtils {
    ...
    public static SelectBody findMappingVars(RobertOCLParser visitor, String variable) {
    ...
    public static IteratorSource getSourceLevelVar(RobertOCLParser visitor) {
        int currentLevel = ((RobertOCLParser) visitor).getLevelOfSets();
    ...
    public static boolean isSetOfSetAfterCollect(IteratorExp iteratorExp, RobertStmVisitor visitor) {
        if (iteratorExp.getSource() instanceof IteratorExp) {
            ...
            if (insideIter.kind == IteratorKind.collect) {
                if (((RobertOCLParser) visitor).getLevelOfSets() > 1) {
                    return true;
                }
            }
        }
     ...
     * @since 1.0
     */
    public static List<String> SVars(OclExpression ePrime, RobertOCLParser visitor) {
...
//    }
    ...
    private static OclExpression findSourceOfVar(RobertOCLParser visitor, String var) {
