...
public class IntegerLiteralExpDeParser extends OclExpressionDeParser {
    private String deParsedStr;
    
    public IntegerLiteralExpDeParser() {
        this("");
    }

    public IntegerLiteralExpDeParser(String deParsedStr) {
    ...
    public void visit( IntegerLiteralExp integerLiteralExp ) {
        this.deParsedStr = String.valueOf(integerLiteralExp.getIntegerSymbol());
    }
