...
public class StringLiteralExpDeParser extends OclExpressionDeParser {
    
    private String deParsedStr;

    public StringLiteralExpDeParser() {
        this("");
    }

    public StringLiteralExpDeParser(String deParsedStr) {
    ...
    public void visit( StringLiteralExp strLiteralExp ) {
        this.deParsedStr = "'" + strLiteralExp.getStringSymbol() + "'";
    }
